    ...
    <div class="btn-group" role="group">
     ...
     <a class="btn btn-secondary" href="profile.php?friend=<?php echo $_GET['friend']; ?>">Profile</a> 
            <form method="post" action="friends.php" id="remove-friend-form">
                ...
                <button type="submit" name="action" class="btn btn-primary bg-danger" value="delete-friend" id="remove-friend-button">
                    <a class="red-link">
                        Remove Friend
                    </a>
                </button>
            ...
            <div class="container text-left" class="position-relative">
                <ul class="row align-items-start" id="chatbox">
                </ul>
            </div>
